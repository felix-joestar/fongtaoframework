...
public class SysConfigController {
    ...
    @PreAuthorize("hasAuthority('admin:sys-config:page')")
    ...
    @PreAuthorize("hasAuthority('admin:sys-config:get-by-id')")
    ...
    @PreAuthorize("hasAuthority('admin:sys-config:create')")
    ...
    @PreAuthorize("hasAuthority('admin:sys-config:update-by-id')")
    ...
    @PreAuthorize("hasAuthority('admin:sys-config:delete-by-id')")
